/**
 * Poll for agent response — shared by tasks send and tasks create.
 *
 * Polls GET /tasks/{id}/messages every 2 seconds until an assistant
 * message appears with a sequence number higher than the given threshold.
 */
